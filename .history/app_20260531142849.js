...
const tshirtImages = {
  front: "https://i.postimg.cc/BQjg6h6B/Chat-GPT-Image-Jan-11-2026-04-51-44-PM.png",
  back:  "https://i.postimg.cc/4NY5d8dt/Chat-GPT-Image-Jan-11-2026-04-51-51-PM.png",
  right: "https://i.postimg.cc/hPXrjCjm/Chat-GPT-Image-Jan-11-2026-04-51-53-PM.png",
  left:  "https://i.postimg.cc/hPXrjCjm/Chat-GPT-Image-Jan-11-2026-04-51-53-PM.png"
};
...
function applyArea() {
  ...
  const maskVal = `url("${imgSrc}")`;
  colourLayerEl.style.webkitMaskImage = maskVal;
  colourLayerEl.style.maskImage       = maskVal;
